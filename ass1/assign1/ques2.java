	...
	public static void main(String[] args)
	{
        ...
        while(temp_no_of_sources != n_of_sources+1)
        {
		    ...
		    while(temp != n_of_packets+1)
			{
				...
				array_of_source_objects[temp_no_of_sources].packet_generation_start_time += array_of_source_objects[temp_no_of_sources].rate;
			    temp++;
		...
		// for(int i = 1; i <= n_of_sources; i++)
		// {
			try (Writer writer = new FileWriter("ques2.csv"))
			{
               writer.append("Packet Sending Rate").append(",").append("Average Delay").append(eol); 
		       ArrayList<Result> list1 = map.get(1);
		       ArrayList<Result> list2 = map.get(2);
		       ArrayList<Result> list3 = map.get(3);
		       for(int i = 0; i < list1.size(); i++)
		       {
		       	   writer.append(list1.get(i).rate+"").append(",").append(list1.get(i).average_delay+"").append(list2.get(i).rate+"").append(",").append(list2.get(i).average_delay+"").append(list3.get(i).rate+"").append(",").append(list3.get(i).average_delay+"").append(eol);
		       }
